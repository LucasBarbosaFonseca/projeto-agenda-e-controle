<?php 
	...
	$sql_code = "SELECT * FROM lab04reserva";
...
<html lang="pt-br">
<head>
	<title>Consultar Reserva do Lab04</title>
	<meta charset="utf-8"/>
	<link rel="stylesheet" type="text/css" href="_css/normalize.css"/>
	<link rel="stylesheet" type="text/css" href="_css/Estilo_Lab04.css"/>
	<script type="text/javascript" src="_javascript/FunctionBuscaReservaLab04.js"></script>
	<!--[if lt IE 9]>
	<script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
	<![endif]-->
</head>
<body>
<h1 class="titulo-form">Consultar Reserva do Lab04</h1>

<a class="ancora-voltar" href="menu.php">Voltar ao menu</a>

<div class="data-grid-lab04">
	<table id="datagrid" class="datagrid">
		...
		<tbody>
			<tr>
				<td><?php echo $linha['ID_RESERVA_LAB04']; ?></td>
				<td><?php 

					if ($linha['DATA_RESERVA_LAB04'] == "") {

						$data_reserva_lab04 = explode("-", $linha['DATA_RESERVA_LAB04']);
				...
				?></td>
				<td><?php echo $select_horario_reserva_lab04[$linha['HORARIO_RESERVA_LAB04']]; ?></td>
				<td><?php echo $linha['RESPONS_RESERVA_LAB04']; ?></td>
				<td>
					<a href="">Alterar</a> |
					<a href="javascript: if(confirm('Tem certeza que deseja excluir essa reserva?'))window.location.href='Excluir_Lab04.php?id_res_lab04=<?php echo $linha['ID_RESERVA_LAB04']; ?>';">Excluir</a>
				</td>
			</tr>
...
<div class="quadro-pesq-reserva-lab04">
	<form>
		<fieldset>
		<legend>Pesquisar por Data:</legend>
			<input type="search" name="valor_data" placeholder="  /  /  " id="pesq" onkeyup="BuscaReservaLab04PorData(this.value)" />
		</fieldset>
	</form>
</div>
</body>
