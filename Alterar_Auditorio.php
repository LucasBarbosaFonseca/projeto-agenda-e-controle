...
<html lang="pt-br">
<head>
	<title>Alterar Reserva do Auditório</title>
	<meta charset="utf-8"/>
...
<body>
<h1 class="titulo-form">Alterar Reserva do Auditório</h1>

<div class="form-reserva-auditorio">
	<form>
		<!-- id reserva auditorio -->
