...
<html lang="pt-br">
<head>
	<title>Alterar Reserva da Sala 704</title>
	<meta charset="utf-8"/>
...
<body>
<h1 class="titulo-form">Alterar Reserva da Sala 704</h1>
...
<div class="form-reserva-sala704">
	<form>
		...
		<br>
		<!-- Botão -->
		<input type="submit" value="Alterar" name="alterar-reserva-sala704"/>
		<!-- -->
	</form>
</div>
</body>
