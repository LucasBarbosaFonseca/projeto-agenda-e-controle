...
<html lang="pt-br">
<head>
	<title>Alterar Reserva do Microfone</title>
	<meta charset="utf-8"/>
...
<h1 class="titulo-form">Alterar Reserva do Microfone</h1>
...
<div class="form-reserva-microfone">
	<form>
		...
		<br>
		<!-- botão -->
		<input type="submit" value="Alterar" name="alterar-reserva-microfone"/>
		<!-- -->
	</form>
</div>
