	...
	function BuscaReservaConversorVGAPorData(valor_data) {
		...
		var url = "BuscaReservaConversorVGA.php?valor_data="+valor_data;
		...
		req.onreadystatechange = function() {
			...
			if (req.readyState == 4 && req.status == 200) {
				...
				//Resposta retornada pelo BuscaReservaConversor.php
