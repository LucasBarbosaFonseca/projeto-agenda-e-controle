...
<html lang="pt-br">
<head>
	<title>Alterar Reserva do Conversor VGA</title>
	<meta charset="utf-8"/>
...
<h1 class="titulo-form">Alterar Reserva do Conversor VGA</h1>
...
<div class="form-reserva-conversor">
	<form>
		...
		<br>
		<!-- botão -->
		<input type="submit" value="Alterar" name="alterar-reserva-conversor"/>
		<!-- -->
	</form>
</div>
