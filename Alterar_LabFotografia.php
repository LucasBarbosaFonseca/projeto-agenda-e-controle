...
<html lang="pt-br">
<head>
	<title>Alterar Reserva do Lab Fotografia</title>
	<meta charset="utf-8"/>
...
<body>
<h1 class="titulo-form">Alterar Reserva do Lab Fotografia</h1>
...
<div class="form-reserva-lab-fotografia">
	<form>
		...
		<br>
		<!-- Botão -->
		<input type="submit" value="Alterar" name="alterar-reserva-lab-fotografia"/>
		<!-- -->
	</form>
</div>
</body>
