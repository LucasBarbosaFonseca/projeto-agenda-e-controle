...
<html lang="pt-br">
<head>
	<title>Alterar Reserva da Sala 708</title>
	<meta charset="utf-8"/>
...
<body>
<h1 class="titulo-form">Alterar Reserva da Sala 708</h1>
...
<div class="form-reserva-sala708">
	<form>
		...
		<br>
		<!-- Botão -->
		<input type="submit" value="Alterar" name="alterar-reserva-sala708"/>
		<!-- -->
	</form>
</div>
</body>
